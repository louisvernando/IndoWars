        ...
        public async Task EnsureSeedData()
        {
            try
            {
                ...
                if (!_context.News.Any())
                {
                    ...
                    {
                        Date = Convert.ToDateTime("06/15/2016"),
                ...
                if (!_context.QIntroductions.Any())
                {
                    ...
                    {
                        Questions =
                            "Siapakah Ketua Uni-Soviet yang menandatangani Perjanjian Gencatan Senjata Jerman-Soviet?",
                    ...
                    {
                        Questions =
                            "Setelah menjadi Reich Chancellor pada tahun 1933, Hitler menyatakan dirinya sebagai?",
                        Answer = new List<aIntroduction>()
                        {
                    ...
                    {
                        Questions =
                            "Buku 'Mein Kampf' yang ditulis oleh hitler, memprediksi bahwa Perang Eropa akan membawa?",
                        Answer = new List<aIntroduction>()
                        {
                            new aIntroduction()
                            {
                                Choices = "A",
                                Text = "Kesepakatan perjanjian dengan Uni-Soviet dalam Invasi"
                            },
                            new aIntroduction() {Choices = "B", Text = "Pemusnahan etnik komunis di Jerman"},
                            new aIntroduction()
                            {
                                Choices = "C",
                                Text = "Pengangkatan jabatan hitler menjadi 'Reich Chancellor'"
                            },
                    ...
                    {
                        Questions =
                            "Pada tahun berapakah, Hitler mulai mempersiapkan persenjataan Jerman untuk memulai invasinya?",
                        Answer = new List<aIntroduction>()
                        {
                    ...
                    {
                        Questions =
                            "Perang apakah yang menjadi titik balik bagi armada U.S untuk melancarkan serangan balasan pada jepang di Pasifik?",
                        Answer = new List<aIntroduction>()
                        {
                    ...
                    {
                        Questions =
                            "Dalam Operasi Barbarossa yang dilakukan oleh hitler, Pasukan Jerman melakukan invasi kepada negara?",
                        Answer = new List<aIntroduction>()
                        {
                    ...
                    {
                        Questions =
                            "Apakah sebutan lain untuk Magiot Line, sebuah benteng yang menghalangi operangi 'Blitzkrieg' Hitler?",
                        Answer = new List<aIntroduction>()
                        {
                ...
                if (!_context.QHindiaBelanda.Any())
                {
                    ...
                    {
                        Questions =
                            "Hindia Belanda merupakan salah satu target utama jepang, saat pertama kali Perang Dunia II dimulai. Apa alasannya?",
                    ...
                    {
                        Questions =
                            "Negara apakah yang dianggap Jepang sebagai musuh terakhirnya, dengan harapan mereka tidak menyerang jepang terlebih dahulu?",
                        Answer = new List<aHindiaBelanda>()
                        {
                    ...
                    {
                        Questions =
                            "Perang apakah yang menjadi penyerangan pertama pasukan jepang dari Hindia Belanda?",
                        Answer = new List<aHindiaBelanda>()
                        {
                    ...
                    {
                        Questions =
                            "Pada perang borneo pasukan Jepang berniat untuk mengambil alih beberapa daerah dibawah ini, kecuali?",
                        Answer = new List<aHindiaBelanda>()
                        {
                    ...
                    {
                        Questions =
                            "Apakah nama kapal Destroyer Jepang yang berhasil ditenggelamkan oleh HNLMS K XVI pada malam 23-24 Desember?",
                        Answer = new List<aHindiaBelanda>()
                        {
                    ...
                    {
                        Questions =
                            "Siapakah nama pasukan belanda yang mencoba untuk menyerang sumber pengiriman jepang dari 'Singkawa II' yang berakhir gagal?",
                        Answer = new List<aHindiaBelanda>()
                        {
                    ...
                    {
                        Questions =
                            "Kemanakah tujuan utama 'The Punjab Regiment' saat melarikan diri dari serangan jepang pada tanggal 25 desember?",
                        Answer = new List<aHindiaBelanda>()
                        {
                ...
                if (!_context.QTarakanBattle.Any())
                {
                    ...
                    {
                        Questions =
                            "Berapa banyak tambang minyak yang dimiliki Tarakan sehingga diincar Jepang pada saat perang Pasifik?",
                        Answer = new List<aTarakanBattle>()
                        {
                    ...
                    {
                        Questions =
                            "Apakah nama operasi yang dilakukan Australia untuk mengambil alih Tarakan pada tahun 1945?",
                        Answer = new List<aTarakanBattle>()
                        {
                    ...
                    {
                        Questions =
                            "Setelah Australia berhasil mengamankan Tarakan, apakah tanggapan warga Tarakan kepada Australia?",
                        Answer = new List<aTarakanBattle>()
                        {
                    ...
                    {
                        Questions =
                            "Siapakah nama komandan yang memimpin Ekspedisi Australia pada perang Tarakan 1945?",
                        Answer = new List<aTarakanBattle>()
                        {
                    ...
                    var question10 = new qTarakanBattle()
                    {
                        ...
                        Answer = new List<aTarakanBattle>()
                        {
                            ...
                            {
                                Choices = "C",
                                Text = "Karena mengebom pesawat tempur Jepang secara diam-diam"
                            },
